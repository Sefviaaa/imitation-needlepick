...
def collect_expert_trajectories(num_episodes=2000, max_steps=100, save_path="expert_trajectories.pkl"):
...
if __name__ == "__main__":
    collect_expert_trajectories(num_episodes=2000, max_steps=100, save_path="expert_trajectories.pkl")
